...
const createBooking = (payload, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userData) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Customer does not exists");
    }
    const serviceData = yield service_model_1.Service.findById(payload === null || payload === void 0 ? void 0 : payload.serviceId);
    if (!serviceData) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Service does not exists");
    }
    ...
    if (!slotData) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Slot does not exists");
    }
