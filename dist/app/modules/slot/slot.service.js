...
const createSlot = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!service) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, 'Service does not exists by this id');
    }
...
const getAvailableSlots = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield slot_model_1.Slot.find({ isBooked: { $ne: 'booked' } })
        .populate('service');
    return result;
});
exports.SlotSlot = {
